...
/**
 * 
 * Object representing a BungeCord node as well as all its affiliated data, such
 * as the name of the node, the IP address of the node, the users connected to
 * this node and its expiration time.
 * 
 * @author xMalware
 *
 */
