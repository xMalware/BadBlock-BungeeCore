...
public class AntiBotData {
	...
	public static AntiBotChecker[] checkers = new AntiBotChecker[] { new ASNChecker(), new ForeignCountryChecker(),
			new LastConnectionChecker(), new TooManyAccountsMemoryChecker(), new UsernameLengthChecker(),
			new UsernameSyllablesChecker(), new VPNChecker() };
