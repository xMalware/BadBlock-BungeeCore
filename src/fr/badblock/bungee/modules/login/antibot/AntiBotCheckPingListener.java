...
public class AntiBotCheckPingListener extends BadListener
{
	...
	private static ServerPing bannedPing = new ServerPing(
			new Protocol("Banni", 0), new Players(0, 0, null), I19n.getMessage(Locale.FRENCH_FRANCE, "bungee.antibot.motd", null), "");
