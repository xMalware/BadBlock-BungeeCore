...
/**
 * 
 * Command to send a message to all players. This command should be used like
 * this: /lalert <message> It can only be used with this permission:
 * bungee.command.alert
 *
 * The message is sent to all players on the server, with an i18n pattern
 * message.
 *
 ...
 * name on it and without using a pattern.
 *
 * @author xMalware
 *
 */
public class AlertCommand extends BadCommand {
	 ...
	 */
	public AlertCommand() {
		super("lalert", "bungee.command.alert", "alert");
	}
