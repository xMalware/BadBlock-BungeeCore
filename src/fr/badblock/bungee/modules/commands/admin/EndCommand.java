...
/**
 * 
 * Command to stop the proxy server where this command is executed. It is usable
 * by players with the following permission: bungee.command.end
 *
...
public class EndCommand extends BadCommand {
	...
	public void run(CommandSender sender, String[] args) {
		...
		I19n.sendMessage(sender, "bungee.commands.end.message", null,
				BadBungee.getInstance().getConfig().getBungeeName());
