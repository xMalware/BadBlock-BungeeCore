...
public enum PunishmentType
{
	...
	BAN(new PunishmentWorkerBan()),
	BANIP(new PunishmentWorkerBanIp()),
	KICK(new PunishmentWorkerKick()),
	MUTE(new PunishmentWorkerMute()),
	UNBAN(new PunishmentWorkerUnban()),
	UNBANIP(new PunishmentWorkerUnbanIp()),
	UNMUTE(new PunishmentWorkerUnmute()),
	WARN(new PunishmentWorkerWarn());
