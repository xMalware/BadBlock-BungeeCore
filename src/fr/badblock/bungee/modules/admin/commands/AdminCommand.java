...
/**
 * 
 *	Command to send a message to all players using the nickname of the administrator in question. It's like a general alert command on the server.
 *	This command should be used like this: /admin <message>
 *	It can only be used with this permission: bungee.command.admin
 *
 *	The message is sent with the sender's nickname to all players on the server, with an i18n pattern message.
 *
 ...
 * By putting &h in front of his message, the player can send a complete message. In this case, he can use the colors.
 *
 * @author xMalware
 *
 */
...
public class AdminCommand extends BadCommand
{
	...
	public void run(CommandSender sender, String[] args)
	{
		...
		if (args.length == 0) 
		{
			...
			I19n.sendMessage(sender, "commands.admin.usage", null);
		...
		else
		{
			...
			message = I19n.getMessages(sender, "commands.admin.pattern", null, sender.getName(), message)[0];
		}
